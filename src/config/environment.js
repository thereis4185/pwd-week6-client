...
const getEnvironmentConfig = () => {
  ...
  const config = {
    ...
    production: {
      ...
      apiUrl: import.meta.env.VITE_API_URL || 'https://pwd-week5-thereis4185.onrender.com',
      clientUrl: import.meta.env.VITE_CLIENT_URL || 'https://pwd-week6-client-kappa.vercel.app',
    }
  };
